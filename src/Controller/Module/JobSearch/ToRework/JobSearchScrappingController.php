...
namespace App\Controller\Module\JobSearch\ToRework;

use App\Controller\Core\Application;
use App\Controller\Module\JobSearch\JobSearchDomCrawlerController;
use App\Controller\Module\JobSearch\JobSearchKeywordsController;
 ...
 */
class JobSearchScrappingController extends AbstractController
{
    /**
    ...
    /**
     * @var JobSearchKeywordsController $keywordsController
     */
    private $keywordsController;

    /**
     * @var JobSearchDecisionController $decisionController
     */
    ...
    public function __construct(
        ...
        JobSearchKeywordsController      $keywordsController,
        JobSearchDecisionController      $decisionController,
        Application             $app
    ) {
    ...
    public function buildAjaxScrapDataRequestDTOFromRequest(Request $request): AjaxScrapDataRequestDTO {
        ...
        if( $searchSetting instanceof JobSearchSetting ){
